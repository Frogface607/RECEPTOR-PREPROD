...
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://recipe-master-7.preview.emergentagent.com')
...
def test_nutrition_calculator(techcard=None):
    ...
    try:
        ...
        if len(nutrition_sections) >= 2:
            ...
            log_test(f"Nutrition Calculator: Missing nutrition sections. Present: {nutrition_sections}", "ERROR")
            return False
