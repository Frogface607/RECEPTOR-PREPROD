...
- ПРАВИЛА ЦЕНООБРАЗОВАНИЯ:
  ...
  * Примеры правильных количеств ингредиентов на одну порцию:
    ...
    - Соус: 30-50мл
    - Специи: 1-5г
  * ЦЕНООБРАЗОВАНИЕ НА ИЮЛЬ 2025:
    - Используй РЕАЛЬНЫЕ рыночные цены которые ты помнишь из данных
    - Примени инфляцию: цены выросли на 15-20% с 2024 года
    - Региональный коэффициент: {regional_coefficient}x
    - Коэффициент заведения: {venue_price_multiplier}x
    - ВАЖНО: Учитывай категорию продукта!
      • ПРЕМИУМ (семга, телятина, трюфели): рыночная цена × 1.3-1.5
      • СТАНДАРТ (курица, свинина, овощи): рыночная цена × 1.0-1.2  
      • БЮДЖЕТ (картофель, лук, крупы): рыночная цена × 0.8-1.0
  * Формула: Рыночная цена ты знаешь × инфляция 2025 × региональный коэффициент × коэффициент заведения × категория продукта
  * РЕАЛИСТИЧНЫЕ ЦЕНЫ ИЮЛЬ 2025:
    - Семга охлажденная: 1800-2200₽/кг
    - Телятина: 1200-1500₽/кг
    - Говядина: 800-1200₽/кг
    - Курица: 400-600₽/кг
    - Картофель: 100-150₽/кг в ресторанах
    - Лук: 120-180₽/кг в ресторанах
