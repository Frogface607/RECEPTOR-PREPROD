...
VENUE_TYPES = {
    "fine_dining": {
        "name": "Fine Dining",
        "description": "╨Т╤Л╤Б╨╛╨║╨╛╨║╨╗╨░╤Б╤Б╨╜╤Л╨╣ ╤А╨╡╤Б╤В╨╛╤А╨░╨╜ ╤Б ╨╕╨╖╤Л╤Б╨║╨░╨╜╨╜╨╛╨╣ ╨║╤Г╤Е╨╜╨╡╨╣",
        "price_multiplier": 1.5,
        "typical_markup": "4.0x",
        "complexity_level": "high",
        "techniques": ["╤Б╤Г-╨▓╨╕╨┤", "╨╝╨╛╨╗╨╡╨║╤Г╨╗╤П╤А╨╜╨░╤П ╨│╨░╤Б╤В╤А╨╛╨╜╨╛╨╝╨╕╤П", "╨┐╤А╨╛╤Д╨╡╤Б╤Б╨╕╨╛╨╜╨░╨╗╤М╨╜╨░╤П ╨┐╨╛╨┤╨░╤З╨░", "╤Б╨╗╨╛╨╢╨╜╤Л╨╡ ╤Б╨╛╤Г╤Б╤Л"],
        "service_style": "table_service",
        "portion_style": "artistic"
    },
    "food_truck": {
        "name": "Food Truck",
        "description": "╨Ь╨╛╨▒╨╕╨╗╤М╨╜╨░╤П ╤В╨╛╤З╨║╨░ ╨┐╨╕╤В╨░╨╜╨╕╤П ╨▒╤Л╤Б╤В╤А╨╛╨│╨╛ ╨╛╨▒╤Б╨╗╤Г╨╢╨╕╨▓╨░╨╜╨╕╤П",
        "price_multiplier": 0.6,
        "typical_markup": "2.5x",
        "complexity_level": "low",
        "techniques": ["╨│╤А╨╕╨╗╤М", "╤Д╤А╨╕╤В╤О╤А", "╨▒╤Л╤Б╤В╤А╨░╤П ╨╢╨░╤А╨║╨░", "╨┐╤А╨╛╤Б╤В╨░╤П ╤Б╨▒╨╛╤А╨║╨░"],
        "service_style": "fast_casual",
        "portion_style": "handheld"
    },
    "bar_pub": {
        "name": "╨С╨░╤А/╨Я╨░╨▒",
        "description": "╨С╨░╤А ╤Б ╨╖╨░╨║╤Г╤Б╨║╨░╨╝╨╕ ╨╕ ╨╜╨░╨┐╨╕╤В╨║╨░╨╝╨╕",
        "price_multiplier": 0.9,
        "typical_markup": "3.5x",
        "complexity_level": "medium",
        "techniques": ["╨│╤А╨╕╨╗╤М", "╤Д╤А╨╕╤В╤О╤А", "╤Б╨╜╨╡╨║╨╕", "╨╖╨░╨║╤Г╤Б╨║╨╕ ╨┐╨╛╨┤ ╨░╨╗╨║╨╛╨│╨╛╨╗╤М"],
        "service_style": "bar_service", 
        "portion_style": "sharing"
    },
    "cafe": {
        "name": "╨Ъ╨░╤Д╨╡",
        "description": "╨г╤О╤В╨╜╨╛╨╡ ╨║╨░╤Д╨╡ ╤Б ╨┤╨╛╨╝╨░╤И╨╜╨╡╨╣ ╨░╤В╨╝╨╛╤Б╤Д╨╡╤А╨╛╨╣",
    ...
    "coffee_shop": {
        "name": "╨Ъ╨╛╤Д╨╡╨╣╨╜╤П",
        "description": "╨б╨┐╨╡╤Ж╨╕╨░╨╗╨╕╨╖╨╕╤А╨╛╨▓╨░╨╜╨╜╨░╤П ╨║╨╛╤Д╨╡╨╣╨╜╤П ╤Б ╨░╨▓╤В╨╛╤А╤Б╨║╨╕╨╝╨╕ ╨╜╨░╨┐╨╕╤В╨║╨░╨╝╨╕",
        "price_multiplier": 0.7,
        "typical_markup": "2.8x",
        "complexity_level": "medium",
        "techniques": ["╨░╨╗╤М╤В╨╡╤А╨╜╨░╤В╨╕╨▓╨╜╨╛╨╡ ╨╖╨░╨▓╨░╤А╨╕╨▓╨░╨╜╨╕╨╡", "╨╗╨░╤В╤В╨╡-╨░╤А╤В", "╨▓╤Л╨┐╨╡╤З╨║╨░", "╨┤╨╡╤Б╨╡╤А╤В╤Л"],
        "service_style": "counter_service",
        "portion_style": "grab_and_go"
    },
    "food_court": {
        "name": "╨д╤Г╨┤-╨║╨╛╤А╤В",
        "description": "╨в╨╛╤З╨║╨░ ╨▓ ╤В╨╛╤А╨│╨╛╨▓╨╛╨╝ ╤Ж╨╡╨╜╤В╤А╨╡ ╨╕╨╗╨╕ ╤Д╤Г╨┤-╨║╨╛╤А╤В╨╡",
        "price_multiplier": 0.7,
        "typical_markup": "2.5x",
        "complexity_level": "low",
        "techniques": ["╨▒╤Л╤Б╤В╤А╨╛╨╡ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╨╡", "╤Б╤В╨░╨╜╨┤╨░╤А╤В╨╕╨╖╨░╤Ж╨╕╤П", "╤А╨░╨╖╨╛╨│╤А╨╡╨▓", "╤Б╨▒╨╛╤А╨║╨░"],
        "service_style": "quick_service",
        "portion_style": "standard"
    },
    "canteen": {
        "name": "╨б╤В╨╛╨╗╨╛╨▓╨░╤П",
        "description": "╨Ь╨░╤Б╤Б╨╛╨▓╨╛╨╡ ╨┐╨╕╤В╨░╨╜╨╕╨╡ ╨┤╨╗╤П ╨╛╤Д╨╕╤Б╨╛╨▓, ╤И╨║╨╛╨╗, ╨┐╤А╨╡╨┤╨┐╤А╨╕╤П╤В╨╕╨╣",
        "price_multiplier": 0.5,
        "typical_markup": "2.0x",
        "complexity_level": "low",
        "techniques": ["╨╝╨░╤Б╤Б╨╛╨▓╨╛╨╡ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╨╡", "╨┐╤А╨╛╤Б╤В╤Л╨╡ ╤В╨╡╤Е╨╜╨╕╨║╨╕", "╨▒╨╛╨╗╤М╤И╨╕╨╡ ╨╛╨▒╤К╨╡╨╝╤Л"],
        "service_style": "cafeteria",
        "portion_style": "generous"
    },
    "kids_cafe": {
        "name": "╨Ф╨╡╤В╤Б╨║╨╛╨╡ ╨║╨░╤Д╨╡",
        "description": "╨б╨╡╨╝╨╡╨╣╨╜╨╛╨╡ ╨║╨░╤Д╨╡ ╤Б ╨┤╨╡╤В╤Б╨║╨╕╨╝ ╨╝╨╡╨╜╤О ╨╕ ╤А╨░╨╖╨▓╨╗╨╡╤З╨╡╨╜╨╕╤П╨╝╨╕",
        "price_multiplier": 0.8,
        "typical_markup": "3.0x",
        "complexity_level": "low",
        "techniques": ["╨▒╨╡╨╖╨╛╨┐╨░╤Б╨╜╨╛╨╡ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╨╡", "╤П╤А╨║╨░╤П ╨┐╨╛╨┤╨░╤З╨░", "╨┐╤А╨╛╤Б╤В╤Л╨╡ ╨▓╨║╤Г╤Б╤Л"],
        "service_style": "family_friendly",
        "portion_style": "kid_friendly"
    },
    "night_club": {
        "name": "╨Э╨╛╤З╨╜╨╛╨╣ ╨║╨╗╤Г╨▒",
        "description": "╨Ч╨░╨▓╨╡╨┤╨╡╨╜╨╕╨╡ ╤Б ╨╜╨╛╤З╨╜╤Л╨╝╨╕ ╤А╨░╨╖╨▓╨╗╨╡╤З╨╡╨╜╨╕╤П╨╝╨╕",
        "price_multiplier": 1.2,
        "typical_markup": "4.5x",
        "complexity_level": "low", 
        "techniques": ["╤Д╨╕╨╜╨│╨╡╤А-╤Д╤Г╨┤", "╨┐╤А╨╛╤Б╤В╤Л╨╡ ╨╖╨░╨║╤Г╤Б╨║╨╕", "╨▒╨╡╨╖ ╤Б╤В╨╛╨╗╨╛╨▓╤Л╤Е ╨┐╤А╨╕╨▒╨╛╤А╨╛╨▓"],
        "service_style": "standing",
        "portion_style": "finger_food"
    },
    "family_restaurant": {
        "name": "╨б╨╡╨╝╨╡╨╣╨╜╤Л╨╣ ╤А╨╡╤Б╤В╨╛╤А╨░╨╜",
        "description": "╨а╨╡╤Б╤В╨╛╤А╨░╨╜ ╨┤╨╗╤П ╤Б╨╡╨╝╨╡╨╣ ╤Б ╨┤╨╡╤В╤М╨╝╨╕",
        "price_multiplier": 1.0,
        "typical_markup": "3.0x",
        "complexity_level": "medium",
        "techniques": ["╨┤╨╛╨╝╨░╤И╨╜╤П╤П ╨║╤Г╤Е╨╜╤П", "╨▒╨╛╨╗╤М╤И╨╕╨╡ ╨┐╨╛╤А╤Ж╨╕╨╕", "╨┐╤А╨╛╤Б╤В╤Л╨╡ ╤А╨╡╤Ж╨╡╨┐╤В╤Л"],
        "service_style": "family_friendly",
        "portion_style": "generous"
    },
    "fast_food": {
        "name": "╨д╨░╤Б╤В-╤Д╤Г╨┤",
        "description": "╨С╤Л╤Б╤В╤А╨╛╨╡ ╨┐╨╕╤В╨░╨╜╨╕╨╡ ╤Б ╤Б╤В╨░╨╜╨┤╨░╤А╤В╨╕╨╖╨╕╤А╨╛╨▓╨░╨╜╨╜╤Л╨╝ ╨╝╨╡╨╜╤О",
        "price_multiplier": 0.6,
        "typical_markup": "2.5x",
        "complexity_level": "low",
        "techniques": ["╤Д╤А╨╕╤В╤О╤А", "╨│╤А╨╕╨╗╤М", "╤Б╤В╨░╨╜╨┤╨░╤А╤В╨╕╨╖╨░╤Ж╨╕╤П", "╨▒╤Л╤Б╤В╤А╨░╤П ╤Б╨▒╨╛╤А╨║╨░"],
        "service_style": "quick_service",
        "portion_style": "standard"
    },
    "bakery_cafe": {
        "name": "╨Я╨╡╨║╨░╤А╨╜╤П-╨║╨░╤Д╨╡",
        "description": "╨Я╨╡╨║╨░╤А╨╜╤П ╤Б ╨║╨░╤Д╨╡ ╨╕ ╤Б╨▓╨╡╨╢╨╡╨╣ ╨▓╤Л╨┐╨╡╤З╨║╨╛╨╣",
        "price_multiplier": 0.8,
        "typical_markup": "3.2x",
        "complexity_level": "medium",
        "techniques": ["╨▓╤Л╨┐╨╡╤З╨║╨░", "╤Е╨╗╨╡╨▒╨╛╨┐╨╡╤З╨╡╨╜╨╕╨╡", "╨║╨╛╨╜╨┤╨╕╤В╨╡╤А╤Б╨║╨╛╨╡ ╨╕╤Б╨║╤Г╤Б╤Б╤В╨▓╨╛"],
        "service_style": "counter_service",
        "portion_style": "artisan"
    },
    "buffet": {
        "name": "╨С╤Г╤Д╨╡╤В/╨и╨▓╨╡╨┤╤Б╨║╨╕╨╣ ╤Б╤В╨╛╨╗",
        "description": "╨б╨░╨╝╨╛╨╛╨▒╤Б╨╗╤Г╨╢╨╕╨▓╨░╨╜╨╕╨╡ ╤Б ╤И╨╕╤А╨╛╨║╨╕╨╝ ╨▓╤Л╨▒╨╛╤А╨╛╨╝ ╨▒╨╗╤О╨┤",
        "price_multiplier": 0.9,
        "typical_markup": "2.2x",
        "complexity_level": "medium",
        "techniques": ["╨╝╨░╤Б╤Б╨╛╨▓╨╛╨╡ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╨╡", "╨┤╨╗╨╕╤В╨╡╨╗╤М╨╜╨╛╨╡ ╤Е╤А╨░╨╜╨╡╨╜╨╕╨╡", "╤А╨░╨╖╨╜╨╛╨╛╨▒╤А╨░╨╖╨╕╨╡"],
        "service_style": "self_service",
        "portion_style": "variety"
    },
    "street_food": {
        "name": "╨г╨╗╨╕╤З╨╜╨░╤П ╨╡╨┤╨░",
        "description": "╨в╨╛╤А╨│╨╛╨▓╤Л╨╡ ╤В╨╛╤З╨║╨╕ ╤Б ╤Г╨╗╨╕╤З╨╜╨╛╨╣ ╨╡╨┤╨╛╨╣",
        "price_multiplier": 0.5,
        "complexity_level": "low",
        "techniques": ["╨┐╤А╨╛╤Б╤В╨╛╨╡ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╨╡", "╨╝╨╛╨▒╨╕╨╗╤М╨╜╨╛╤Б╤В╤М", "╨▒╤Л╤Б╤В╤А╨░╤П ╨┐╨╛╨┤╨░╤З╨░"],
...
async def chat_with_assistant(request: dict):
    ...
    system_prompt = """╨в╤Л RECEPTOR тАФ ╨┐╤А╨╛╤Д╨╡╤Б╤Б╨╕╨╛╨╜╨░╨╗╤М╨╜╤Л╨╣ AI-╨░╤Б╤Б╨╕╤Б╤В╨╡╨╜╤В ╨┤╨╗╤П ╤А╨╡╤Б╤В╨╛╤А╨░╨╜╨╜╨╛╨│╨╛ ╨▒╨╕╨╖╨╜╨╡╤Б╨░. 
╨в╨▓╨╛╤П ╤Б╨┐╨╡╤Ж╨╕╨░╨╗╨╕╨╖╨░╤Ж╨╕╤П:
- ╨а╨╡╤Ж╨╡╨┐╤В╤Л ╨╕ ╤В╨╡╤Е╨╜╨╕╨║╨╕ ╨┐╤А╨╕╨│╨╛╤В╨╛╨▓╨╗╨╡╨╜╨╕╤П
- ╨д╨╕╨╜╨░╨╜╤Б╨╛╨▓╤Л╨╡ ╤А╨░╤Б╤З╨╡╤В╤Л (╤Б╨╡╨▒╨╡╤Б╤В╨╛╨╕╨╝╨╛╤Б╤В╤М, ╨╜╨░╤Ж╨╡╨╜╨║╨░, ╨╝╨░╤А╨╢╨░)
- ╨Ю╨┐╤В╨╕╨╝╨╕╨╖╨░╤Ж╨╕╤П ╨╝╨╡╨╜╤О ╨╕ ╨░╨╜╨░╨╗╨╕╨╖ ╤А╨╡╨╜╤В╨░╨▒╨╡╨╗╤М╨╜╨╛╤Б╤В╨╕
- ╨г╨┐╤А╨░╨▓╨╗╨╡╨╜╤З╨╡╤Б╨║╨╕╨╡ ╨▓╨╛╨┐╤А╨╛╤Б╤Л ╤А╨╡╤Б╤В╨╛╤А╨░╨╜╨╜╨╛╨│╨╛ ╨▒╨╕╨╖╨╜╨╡╤Б╨░
- ╨Ъ╤Г╨╗╨╕╨╜╨░╤А╨╜╤Л╨╡ ╤Б╨╛╨▓╨╡╤В╤Л ╨╕ ╤А╨╡╨║╨╛╨╝╨╡╨╜╨┤╨░╤Ж╨╕╨╕
- HACCP ╨╕ ╨б╨░╨╜╨Я╨╕╨Э ╨╜╨╛╤А╨╝╨░╤В╨╕╨▓╤Л
- HR ╨╕ ╤Г╨┐╤А╨░╨▓╨╗╨╡╨╜╨╕╨╡ ╨┐╨╡╤А╤Б╨╛╨╜╨░╨╗╨╛╨╝
- ╨Ь╨░╤А╨║╨╡╤В╨╕╨╜╨│ ╨╕ SMM
- ╨в╨╡╤Е╨╜╨╕╤З╨╡╤Б╨║╨░╤П ╨┤╨╛╨║╤Г╨╝╨╡╨╜╤В╨░╤Ж╨╕╤П iiko

╨Т╤Б╨╡╨│╨┤╨░ ╨╛╤В╨▓╨╡╤З╨░╨╣ ╨┐╤А╨╛╤Д╨╡╤Б╤Б╨╕╨╛╨╜╨░╨╗╤М╨╜╨╛, ╨╜╨╛ ╨┤╨╛╤Б╤В╤Г╨┐╨╜╨╛. ╨Ф╨░╨▓╨░╨╣ ╨║╨╛╨╜╨║╤А╨╡╤В╨╜╤Л╨╡ ╤Б╨╛╨▓╨╡╤В╤Л ╤Б ╨┐╤А╨╕╨╝╨╡╤А╨░╨╝╨╕ ╨╕ ╤Д╨╛╤А╨╝╤Г╨╗╨░╨╝╨╕.
╨Х╤Б╨╗╨╕ ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╨┐╤А╨╛╤Б╨╕╤В ╤Б╨╛╨╖╨┤╨░╤В╤М ╤В╨╡╤Е╨║╨░╤А╤В╤Г ╨╕╨╗╨╕ ╤А╨╡╤Ж╨╡╨┐╤В, ╨╕╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╣ ╤Д╤Г╨╜╨║╤Ж╨╕╤О generateTechcard.
╨Х╤Б╨╗╨╕ ╤Б╨┐╤А╨░╤И╨╕╨▓╨░╨╡╤В ╨╛ ╤А╨░╤Б╤З╨╡╤В╨░╤Е, ╨┤╨░╨▓╨░╨╣ ╨║╨╛╨╜╨║╤А╨╡╤В╨╜╤Л╨╡ ╤Д╨╛╤А╨╝╤Г╨╗╤Л ╨╕ ╨┐╤А╨╕╨╝╨╡╤А╤Л.
    ...
    tools = [
        {
            ...
            "function": {
                ...
                "description": "╨б╨╛╨╖╨┤╨░╤В╤М ╤В╨╡╤Е╨╜╨╛╨╗╨╛╨│╨╕╤З╨╡╤Б╨║╤Г╤О ╨║╨░╤А╤В╤Г ╨▒╨╗╤О╨┤╨░. ╨Ш╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╣ ╨║╨╛╨│╨┤╨░ ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╨┐╤А╨╛╤Б╨╕╤В ╤Б╨╛╨╖╨┤╨░╤В╤М ╤В╨╡╤Е╨║╨░╤А╤В╤Г, ╤А╨╡╤Ж╨╡╨┐╤В ╨╕╨╗╨╕ ╨▒╨╗╤О╨┤╨╛.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "dish_name": {
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "╨Я╨╛╨╕╤Б╨║ ╨┐╨╛ ╨▒╨░╨╖╨╡ ╨╖╨╜╨░╨╜╨╕╨╣ RECEPTOR (HACCP, ╨б╨░╨╜╨Я╨╕╨Э, HR, ╤Д╨╕╨╜╨░╨╜╤Б╤Л, ╤В╨╡╤Е╨╜╨╕╨║╨╕, iiko ╨┤╨╛╨║╤Г╨╝╨╡╨╜╤В╨░╤Ж╨╕╤П, ╨▒╨╕╨╖╨╜╨╡╤Б-╨║╨╡╨╣╤Б╤Л). ╨Ш╤Б╨┐╨╛╨╗╤М╨╖╤Г╨╣ ╨┤╨╗╤П ╨╛╤В╨▓╨╡╤В╨╛╨▓ ╨╜╨░ ╨▓╨╛╨┐╤А╨╛╤Б╤Л ╨╛ ╨╜╨╛╤А╨╝╨░╤Е, ╤Б╤В╨░╨╜╨┤╨░╤А╤В╨░╤Е, ╨╗╤Г╤З╤И╨╕╤Е ╨┐╤А╨░╨║╤В╨╕╨║╨░╤Е.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
