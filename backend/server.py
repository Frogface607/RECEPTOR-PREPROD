...
- ПРАВИЛА ЦЕНООБРАЗОВАНИЯ:
  ...
  * Формула расчета: (Базовая цена 2024 год × 1.12 × региональный коэффициент × коэффициент заведения)
...
**Название:** [исходное название] — ПРОКАЧАННАЯ ВЕРСИЯ
