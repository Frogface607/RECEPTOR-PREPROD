...
def test_tc003_analytics():
    ...
    try:
        ...
        response = requests.get(
            "https://dashboard-rescue-8.preview.emergentagent.com/api/user-history/p1_test",
            timeout=30
        )
        ...
        # Test menu-projects  
        response = requests.get(
            "https://dashboard-rescue-8.preview.emergentagent.com/api/menu-projects/p1_test",
            timeout=30
        )
