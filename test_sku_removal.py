        ...
        if response.status_code == 200:
            ...
            if card:
                ...
                print_response = requests.post(
                    "https://menu-ai-platform-1.preview.emergentagent.com/api/v1/techcards.v2/print",
                    json=card,
                    timeout=30
                )
        ...
        if response.status_code == 200:
            ...
            if card_id:
                ...
                pdf_response = requests.get(
                    f"https://menu-ai-platform-1.preview.emergentagent.com/api/v1/techcards.v2/{card_id}/pdf",
                    timeout=30
                )
