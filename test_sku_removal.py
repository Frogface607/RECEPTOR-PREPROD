...
def test_html_sku_removal():
    ...
    try:
        ...
        response = requests.post(
            "https://iiko-bridge.preview.emergentagent.com/api/v1/techcards.v2/generate",
        ...
        if response.status_code == 200:
            ...
            if card:
                ...
                print_response = requests.post(
                    "https://iiko-bridge.preview.emergentagent.com/api/v1/techcards.v2/print",
                    json=card,
                    timeout=30
                )
        ...
        if response.status_code == 200:
            ...
            if card_id:
                ...
                pdf_response = requests.get(
                    f"https://iiko-bridge.preview.emergentagent.com/api/v1/techcards.v2/{card_id}/pdf",
                    timeout=30
                )
