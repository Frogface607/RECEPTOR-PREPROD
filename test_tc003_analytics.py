...
def test_user_history_api():
    ...
    try:
        response = requests.get(
            f"https://menu-automation.preview.emergentagent.com/api/user-history/{test_user_id}",
            timeout=30
        )
...
def test_menu_projects_api():
    ...
    try:
        response = requests.get(
            f"https://menu-automation.preview.emergentagent.com/api/menu-projects/{test_user_id}",
            timeout=30
        )
