const COLUMNS = [
  {
    ...
    body: "Отчёт по выручке, OLAP, смены, фудкост, техкарты, стоп-лист и команда — каждый утром заново. Excel, копипаст, нервы.",
    tone: "muted" as const,
  },
  {
    eyebrow: "Сейчас",
      ...
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-[16px] leading-relaxed text-muted-foreground">
            BI, Copilot, техкарты, меню, команда и ежедневные брифинги собраны
