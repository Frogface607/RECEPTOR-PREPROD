        ...
        {step === 0 ? (
              ...
              <div className="space-y-3 rounded-lg border border-border/50 bg-background/40 p-4 text-[13px] leading-relaxed text-muted-foreground">
                ...
                {demoMode ? (
                  <p className="text-[12px] text-[color:var(--pro)]">
                    В режиме просмотра можно пройти шаги и увидеть кабинет.
                    Чтобы сохранить заведение, iiko и команду, войдите по
                    логину и паролю.
                  </p>
                ) : null}
              </div>
          ...
          <div className="flex flex-col items-center gap-4 py-6 text-center">
            ...
            <p className="max-w-sm text-[14px] leading-relaxed text-muted-foreground">
              {demoMode
                ? "Это режим просмотра: можно проверить путь подключения. Чтобы сохранить заведение, iiko и команду, войдите по логину и паролю."
