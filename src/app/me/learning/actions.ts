  ...
  return {
    ...
    message:
      closedTaskIds.length > 0
        ? "Стандарт сдан. Теперь нужен факт смены: где применили, что изменилось и что проверить утром."
        : taskCloseWarning
          ? "Стандарт сдан. Задача стандарта не закрылась автоматически, но факт смены все равно нужен."
          : "Прогресс сохранен.",
