...
# Add the current directory to Python path to import from backend
sys.path.append('/app')

def test_laboratory_experiment():
    """Test the new LABORATORY feature with image generation"""
    
    # Get backend URL from environment
    backend_url = "https://1f2ccd24-594a-4a71-89be-0e37c8a52cfe.preview.emergentagent.com"
    ...
    try:
        ...
        # Test 4: Laboratory content includes experimental cooking techniques
        experimental_techniques = [
            ...
            "жидкий азот", "трюфел", "икра", "авокадо", "васаби", "юзу"
        ]
        ...
        if len(found_techniques) >= 2:
            ...
            print(f"❌ TEST 4 FAILED: Insufficient experimental techniques ({len(found_techniques)} found, need at least 2)")
            return False
        ...
        if photo_description and len(photo_description) > 10:
            ...
            print(f"   Description preview: {photo_description[:100]}...")
        else:
        ...
        # Show sample content
        print("\n📝 SAMPLE EXPERIMENT CONTENT:")
        print(experiment_content[:300] + "..." if len(experiment_content) > 300 else experiment_content)
        
        print("\n🎉 ALL CORE TESTS PASSED!")
        print("🧪 LABORATORY FEATURE WITH IMAGE GENERATION IS WORKING CORRECTLY")
