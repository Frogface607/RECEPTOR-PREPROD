        ...
        if (descriptionLine) {
          result.push(
            <div key={index} className="my-6">
              ...
              {/* ВСТРОЕННЫЙ РЕДАКТОР ИНГРЕДИЕНТОВ ПОСЛЕ ОПИСАНИЯ */}
          ...
          <div className="lg:col-span-2">
            {techCard ? (
              <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
                ...
                <div className="mt-8 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-400/30 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    {currentIngredients.length === 0 ? (
                      <div className="text-center py-8 text-gray-400">
                        <p className="mb-4">Ингредиенты появятся здесь после генерации техкарты</p>
                        <button 
                          onClick={() => {
                            setCurrentIngredients([
                              { name: 'Говядина (вырезка)', quantity: '250 г', price: '~800 ₽', id: 1 },
                              { name: 'Картофель', quantity: '300 г', price: '~50 ₽', id: 2 },
                              { name: 'Масло сливочное', quantity: '50 г', price: '~25 ₽', id: 3 },
                              { name: 'Соль морская', quantity: '5 г', price: '~2 ₽', id: 4 },
                              { name: 'Перец черный', quantity: '2 г', price: '~1 ₽', id: 5 }
                            ]);
                          }}
                          className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-bold transition-colors"
                        >
              ...
              <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-12 border border-gray-700 text-center">
                ...
                <p className="text-gray-400 mb-8">Введите название блюда слева и нажмите "СОЗДАТЬ ТЕХКАРТУ"</p>
                
                {/* ДЕМО РЕДАКТОРА ИНГРЕДИЕНТОВ */}
                <div className="mt-8 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-400/30 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-bold text-purple-300">🥘 ДЕМО РЕДАКТОРА ИНГРЕДИЕНТОВ</h3>
                    <button 
                      onClick={() => {
                        setCurrentIngredients([...currentIngredients, { 
                          name: '', 
                  ...
                  <div className="space-y-3">
                    {currentIngredients.length === 0 ? (
                      <div className="text-center py-8 text-gray-400">
                        <p className="mb-4">Кликните ЗАГРУЗИТЬ ПРИМЕР чтобы увидеть как работает редактор!</p>
                        <button 
                          onClick={() => {
                            setCurrentIngredients([
                              { name: 'Говядина (премиум)', quantity: '250 г', price: '~800 ₽', id: 1 },
                              { name: 'Картофель молодой', quantity: '300 г', price: '~60 ₽', id: 2 },
                              { name: 'Масло сливочное 82%', quantity: '50 г', price: '~30 ₽', id: 3 },
                              { name: 'Соль морская', quantity: '5 г', price: '~3 ₽', id: 4 },
                              { name: 'Перец черный молотый', quantity: '2 г', price: '~2 ₽', id: 5 }
                            ]);
                          }}
                          className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-bold transition-colors text-lg"
                        >
                          ✨ ЗАГРУЗИТЬ ПРИМЕР ✨
                        </button>
                      </div>
                  ...
                  {currentIngredients.length > 0 && (
                    <div className="mt-6 p-4 bg-gray-800/30 rounded-lg">
                      ...
                      <div className="mt-2 text-sm text-gray-400">
                        *Этот редактор будет отображаться под каждой техкартой!
                      </div>
                    </div>
                  )}
                </div>
